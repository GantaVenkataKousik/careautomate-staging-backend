...
router.get('/get-hcm-chart-info/:companyId', authenticateToken, getHcmChartInfo);

router.post('/assign-tenants-to-hcm', authenticateToken, assignTenantsToHcm);

// Service and Document management routes
router.post('/assign-services-documents', authenticateToken, upload.array('document'), assignServicesAndDocuments);
router.post('/get-services-documents', authenticateToken, getServicesAndDocuments);
...
router.post('/get-assigned-tenants-to-hcm', authenticateToken, getAssignedTenantsToHcm);
