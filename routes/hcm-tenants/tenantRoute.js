...
//tenant info routes
router.get('/get-tenant-info/:companyId', authenticateToken, getTenantChartInfo);


//tenant chart info
router.get('/get-tenant-chart-info/:companyId', authenticateToken, getTenantChartInfo);


router.get('/tenants-running-out-of-units/:companyId', authenticateToken, tenantsRunningOutOfUnits);


// Service Management Routes
router.post('/assign-services-documents', authenticateToken, uploadMiddleware, assignServicesAndDocuments);
...
router.get("/tenant-reassessments/:companyId", authenticateToken, tenantReassessments);


//assigning
router.post('/assign-hcms-to-tenant', authenticateToken, assignHcmsToTenant);
router.post('/get-assigned-hcms-to-tenant', authenticateToken, getAssignedHcmsToTenant);
router.put('/update-tenant', authenticateToken, updateTenant);
router.post('/tenant-profile-edit-history', authenticateToken, tenantProfileEditHistory);
